...
public class TexturePacker
{
	...
	public TexturePacker(Vector2 size, bool rotations): this((int)size.x, (int)size.y, rotations){}
	...
	public void Init(Vector2 size, bool rotations)
	{
		Init((int)size.x, (int) size.y, rotations);
	}
